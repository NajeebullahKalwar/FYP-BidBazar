...
class userverification extends GetView<AuthenticateController> {
  userverification({super.key, this.isBuyer});
  final bool? isBuyer;
    ...
    BuildContext context
      ...
      ListTile(
        ...
        trailing: TextButton(
          onPressed: () {
            // Your action here
            controller.userVerification(userId: buyer.sId!);
